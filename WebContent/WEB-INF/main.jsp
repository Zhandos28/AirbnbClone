    ...
    <header class="header">
        <div class="container">
            <div class="header_inner">
                ...
                <div class="nav">
                    <a class="nav_link" href="rent.do">Rent a house</a>
                    <a class="nav_link" href="register.do">Sign Up</a>
                    <a class="nav_link" href="login.do">Sign In</a>
                </div>
            </div>
            <div class="form-search-container">
                <form action="" method="POST" class="form-search">
                    <div class="search-label-container">
                        <label for="location" class="label-of-search-form">
                            <div class="label-title">
                                Location
                            </div>
                            <input class="input-of-search-form" type="text" name="location" required="" placeholder="Where are you going?">
                        </label>
                    </div>
                    <div class="search-label-container2">
                        <label for="arrival" class="label-of-search-form2">
                            <div class="label-title">
                                Arrival
                            </div>
                            <input class="input-of-search-form2" type="datetime" onfocus="(this.type='Date')" onblur="(this.type='text')" name="location" placeholder="When?">
                        </label>
                    </div>
                    <div class="search-label-container2">
                        <label for="exit" class="label-of-search-form2">
                            <div class="label-title">
                                Exit
                            </div>
                            <input class="input-of-search-form2" type="datetime" onfocus="(this.type='Date')" onblur="(this.type='text')" name="exit" placeholder="When?">
                        </label>
                    </div>
                    <div class="search-label-container">
                        <label for="count-of-guest" class="label-of-search-form">
                            <div class="label-title">
                                Number of guests
                            </div>
                            <input class="input-of-search-form3" type="text" name="count-of-guest" required="" placeholder="Who's coming?">
                            <div class="search-submit-container">
                                <input type="submit" class="submit-of-search-form" value="">
            ...
            <div class="content">
                <img class="content-img" src="https://kor.ill.in.ua/m/610x385/2341633.jpg" alt="Travel photo">
                <h2 class="content-text">It's easy to travel with us</h2>
            </div>
        </div>
    </header>

    <div class="list-of-hotels">
        <h1 class="title-of-hotels-container">Live anywhere you want</h1>
        <div class="container-of-hotels">
            <div class="hotel-list">
                <a href="#" class="link-of-list-hotel">
                    <img class="hotel-list-img" src="https://a0.muscache.com/im/pictures/7d82ca14-56e5-4465-8218-dcfa7d69b6ac.jpg?im_w=320" alt="">
                    <h3 class="title-of-hotel-list">Housing in its entirety</h3>
                </a>
            </div>
            <div class="hotel-list">
                <a href="#" class="link-of-list-hotel">
                    <img class="hotel-list-img" src="https://a0.muscache.com/im/pictures/36f53e61-db8d-403c-9122-5b761c0e4264.jpg?im_w=320" alt="">
                    <h3 class="title-of-hotel-list">Unique accommodation</h3>
                </a>
            </div>
            <div class="hotel-list">
                <a href="#" class="link-of-list-hotel">
                    <img class="hotel-list-img" src="https://a0.muscache.com/im/pictures/7f254627-3922-4880-b8fa-545b8551117e.jpg?im_w=320" alt="">
                    <h3 class="title-of-hotel-list">Farms and nature</h3>
                </a>
            </div>
            <div class="hotel-list">
                <a href="#" class="link-of-list-hotel">
                    <img class="hotel-list-img" src="https://a0.muscache.com/im/pictures/10a638e1-6aff-4313-8033-1275cec83987.jpg?im_w=320" alt="">
                    <h3 class="title-of-hotel-list">It is possible with animals</h3>
                </a>
            </div>
        </div>
        <div class="rent-house">
            <h1 class="title-of-rent-house">Become a master on 4BROTHERS</h1>
            <h3 class="additional-info-about-rent">Discover new opportunities and earn income by renting out housing.</h3>
            <form id="detail">
                <input class="detail-input" type="submit" value="Detailed"name='detailed'>
            </form>
        </div>
    </div>
