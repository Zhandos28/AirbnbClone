    ...
    <div class="input-container">
        <div class="form-box">
            ...
            <div class="button-box">
                <a href="login.do" id="login-button" class="toggle-btn">Login</a>
                <a href="userRegister.do" class="toggle-btn">Register</a>
            </div>
            <div class="social-icons">
                <a href="#" class="social-icons-link"><i class="fab fa-facebook-f fa-lg"></i></a>
                <a href="#" class="social-icons-link"><i class="fab fa-twitter fa-lg"></i></a>
                <a href="#" class="social-icons-link"><i class="fab fa-google fa-lg"></i></a>
            </div>
            <form action="login.do" method="POST" id="login" class="input-group">
            	<input type="hidden" name="csrfToken" value="${csrfToken}" />
            	<c:forEach var="field" items="${form.visibleFields}">
						<label style="color: red;">${field.error}</label>
			  			<input type="${field.type}" class="input-field" placeholder="${field.label }" id="${field.name}" name="${field.name}" value="${field.value}" required><br><br>
				</c:forEach>
                	<!-- <input type="text" class="input-field" placeholder="User Email" required>
	                <input type="password" class="input-field" placeholder="Enter Password" required>
	                <input type="checkbox" class="check-box"><span id="span">Remember Password</span>  -->
	                <input type="submit" class="login-btn" name = "action" value="Login">
            	</form>
        </div>
    </div>
</body>
