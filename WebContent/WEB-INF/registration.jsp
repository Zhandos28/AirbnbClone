    ...
    <div class="input-container">
        <div class="form-box">
            ...
            <div class="button-box">
                <a href="login.do" class="toggle-btn">Log In</a>
                <a href="#" id="register-button" class="toggle-btn">Register</a>
            </div>
            ...
            <form action="userRegister.do" id="login" class="input-group" method="post">
            	<input type="hidden" name="csrfToken" value="${csrfToken}" />
            	<c:forEach var="field" items="${form.visibleFields}">
						<label style="color: red;">${field.error}</label>
			  			<input type="${field.type}" class="input-field" id="${field.name }" placeholder="${field.label }"  name="${field.name}"><br><br>
				</c:forEach>
               ...
               <input type="email" class="input-field" placeholder="Email ID" required>
                ...
                <input type="submit" name="action" class="login-btn" value="Register">
